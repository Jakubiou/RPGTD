...
public class Arrow {
    ...
    public Arrow(int x, int y, int targetX, int targetY) {
        ...
        try {
            bulletTextures[0] = ImageIO.read(new File("res/rpg/bullets/Player_bullet1.png"));
            bulletTextures[1] = ImageIO.read(new File("res/rpg/bullets/Player_bullet2.png"));
            bulletTextures[2] = ImageIO.read(new File("res/rpg/bullets/Player_bullet3.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
