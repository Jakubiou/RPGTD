...
public class Enemy {
    ...
    public Enemy(int x, int y, int hp, Type type) {
        ...
        try {
            switch (type) {
                case SMALL -> texture3 = ImageIO.read(new File("res/rpg/enemy/Enemy_small.png"));
                case SHOOTING -> texture4 = ImageIO.read(new File("res/rpg/enemy/Enemy_mage1.png"));
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        if (type == Type.NORMAL) {
            ...
            try {
                knightTexturesRight[0] = ImageIO.read(new File("res/rpg/enemy/Enemy_knight1.png"));
                knightTexturesRight[1] = ImageIO.read(new File("res/rpg/enemy/Enemy_knight2.png"));
                knightTexturesRight[2] = ImageIO.read(new File("res/rpg/enemy/Enemy_knight3.png"));
                knightTexturesRight[3] = ImageIO.read(new File("res/rpg/enemy/Enemy_knight4.png"));

                knightTexturesLeft[0] = ImageIO.read(new File("res/rpg/enemy/Enemy_knight5.png"));
                knightTexturesLeft[1] = ImageIO.read(new File("res/rpg/enemy/Enemy_knight6.png"));
                knightTexturesLeft[2] = ImageIO.read(new File("res/rpg/enemy/Enemy_knight7.png"));
                knightTexturesLeft[3] = ImageIO.read(new File("res/rpg/enemy/Enemy_knight8.png"));
            } catch (IOException e) {
                e.printStackTrace();
            }
